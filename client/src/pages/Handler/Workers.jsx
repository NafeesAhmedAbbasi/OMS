...
export default function Workers() {
  ...
  // Add worker form
  const EMPTY_WORKER = { name: '', role: 'manufacturer' };
  ...
  // The handler id comes from the auth context — we use /my/dashboard to get it
...
function WorkerSection({ title, workers, onToggle, onDelete, onPayments }) {
  return (
